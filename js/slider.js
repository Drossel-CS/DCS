...
(function (o) {
    ...
    Switchable.fn = Switchable.prototype = {
        init: function (opts) {
            ...
            //$element.find('#caption-0').removeClass('slider-caption').addClass('slider-caption-on');
            $element.find('#caption-0').fadeIn(this.opts.animateSpeed, function () {
        ...
        , fade: function (n) {
            ...
            if (!this.animating && n != this.current) {
                ...
                $next = this.items.eq(n);
                this.opts.callback.start(n);
                //total-vsetky obr, n je nasledujuci
                //alert(this.current);
                //alert(this.total);
               //console.log($element.find('#caption-'+this.current));

            //    $element.find('#caption-'+n).removeClass('slider-caption').addClass('slider-caption-on');
            //    $element.find('#caption-'+this.current).removeClass('slider-caption-on').addClass('slider-caption');
           
               //$element.find('#caption-0').removeClass('slider-caption-on');
               $element.find('#caption-'+this.current).fadeOut(this.opts.animateSpeed);
               $element.find('#caption-'+n).fadeIn(this.opts.animateSpeed, function () {
                //  _this.animating = false;
                //  _this.current = n;
                //  _this.opts.callback.complete(n);
                });

                // $element.find('#caption-'+n).fadeOut(this.opts.animateSpeed);
                // $element.find('#caption-'+this.current).fadeIn(this.opts.animateSpeed, function () {
                //  _this.animating = false;
                //  _this.current = n;
                //  _this.opts.callback.complete(n);
                // });
